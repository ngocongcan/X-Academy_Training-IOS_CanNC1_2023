...
private extension ExchangeRateViewController {
    ...
    func configTableView() {
        register(name: "ExchangeRateTableViewCell")
...
extension ExchangeRateViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "ExchangeRateTableViewCell", for: indexPath) as? ExchangeRateTableViewCell,
              let exchangeRate = viewModel?.exchangeRateList[indexPath.row] else { return UITableViewCell() }
