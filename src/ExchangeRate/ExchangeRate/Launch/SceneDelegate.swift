...
private extension SceneDelegate {
    func createTabbar(windowScene: UIWindowScene) {
        ...
        let goldPriceVC = MarketViewController()
        goldPriceVC.viewModel = MarketViewModel()
        ...
        tabBarController.tabBar.backgroundColor = Color.tabBarBackgroundColor
        tabBarController.tabBar.tintColor = Color.tabarTintColor
